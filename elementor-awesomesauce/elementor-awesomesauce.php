...
function add_elementor_widget_categories2( $elements_manager ) {
    $elements_manager->add_category(
        'CrosFit2Category',
        [
            'title' => __( 'CrosFit', 'elementor-awesomesauce' ),
            'icon' => 'fa fa-home',
        ]
    );

}
add_action( 'elementor/elements/categories_registered', 'add_elementor_widget_categories2' );
